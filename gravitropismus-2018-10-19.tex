...
-kurze Einleitung (2-3 Sätze) warum oder kurz diesen Teil beschreiben 
In diesem Teil...
...
\section{Differenzielles Wachstum} -Plan- Gliederung für diesen Teil, Struktur

Die Krümmung wird meistens durch differenzielles Wachstum zweier Organhälften(?), deren Bereiche(?) wachstumsfähig sind, hervorgerufen.
Die Krümmung bei einer quergelegten und gravitrop reagierenden Pflanze wird hinter der Spitze der Hauptwachstumszonen der Wurzeln bzw. des Sprosses verlaufen (?). Andere Teile bleiben dabei ungekrümmt.
...
Daraufhin findet eine Rückkrümmung statt, bis der Spross, nach einigen Pendelbewegungen, wieder senkrecht steht.] Bilder 

Diese Pendelwachstum, die teilweise (?) nicht von der Erdanziehungskraft abhängen, entstehen, wenn die Pflanze sich zu sehr überkrümmt, wodurch neue gravitrope Reize verursacht werden \parencite[450f]{Strasburger}. -da diese überkrümmt..

-zuerst die reize, dann die Schilderung der Krümmung
...
\begin{itemize}
	\item kurze Einleitung, ca. 3 Sätze
	\item Beschreibung der Struktur des fachlichen Teils
\end{itemize}

\section{Für den Gravitropismus grundlegende Begriffe aus der Botanik}

\begin{itemize}
	\item Abbildung Pflanze mit Beschriftung 
	\item Beschreibung der Struktur des fachlichen Teils
\end{itemize}
