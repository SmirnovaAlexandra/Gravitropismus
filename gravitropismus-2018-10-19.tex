...
Bei gravitrop reagierenden Pilzen werden Amyloplasten durch {\glqq Glanzkörper\grqq} ersetzt, die die Funktion der Statolithen übernehmen, da Pilze keine Stärke enthalten. Diese in Vacuolen liegenden Einschlusskörper besitzen einen hohes spezifisches Gewicht, da sie aus \ce{BaSO4} bestehen \parencite[453f]{Strasburger}.
...
Dadurch wird die lokale \ce{Ca^{2+}}-Konzentration im Cytoplasma erhöht. 
