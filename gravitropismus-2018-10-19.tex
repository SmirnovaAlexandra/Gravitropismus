...
Gravitropismus wurde schon im 19.Jahrhundert entdeckt und ist seit dem ein Thema, das bis heute geforscht wird. Das Pflanzen sich nach der Schwerkraft orientieren, um an das heranzukommen, was sie zum Überleben brauchten, ist schon längst bekannt. Jedoch ist es schwieriger zu verstehen, was genau in der Pflanze für Prozesse und Reaktionen geschehen. Ein Teil dieses Mysteriums wurde schon erforscht und veröffentlicht.

Gravitropismus folgt in drei Schritten ab. Zuerst wird ein verursachter Reiz durch die Statolithen aufgenommen, der in ein Signal umgewandelt wird. Im zweiten Schritt erfolgt dann die Signaltransduktion, wodurch Pflanzenhormone (Auxin oder Gibberelline) aktiviert werden. Diese Hormone führen dazu, dass die Pflanze sich anfängt zu krümmen, der letzte Schritt dieses ganzen Prozesses. 
Diese Bewegung kann man experimentell verfolgen.
...
\begin{figure}[H]
	...
	\caption{1. Wurzelspitze, 2. Hauptwurzel mit Seitenwurzeln der ersten Ordnung, 3. Sprossachse, 4. Sprossspitze (Apex), 5. Koleoptile (Schutzorgan)}
\end{figure}
...
\begin{figure}[H]
	\centering 
	\includegraphics[width = 0.4\linewidth]{images/Statolithen2.png}
...
Dadurch erfolgt die Graviperzeption schneller, denn die Verlagerung der Wurzel hängt  mit der Aufhebung des Statolithendrucks auf die ER-Polster links oder rechts der Wurzelhaube zusammen \parencite[531--532]{Luettge}. 
 ...
 \begin{figure}[H]
 	\centering 
 	\includegraphics[width = 0.5\linewidth]{images/Graviperzeption.jpeg}
...
Wird die Pflanze horizontal gelegt, so werden die Wurzeln gravitropisch gereizt. Dabei gelangen die Protonen nur noch in die untere Flanke der Wurzelspitze hinein und auf der Oberseite hinaus, wodurch auch das elektrische Feld sich ändert \parencite[502-503]{Nultsch}.
...
\begin{figure}[H]
	\centering 
	\includegraphics[width = 0.3\linewidth]{images/diff.png}
...
Die Ursache der Krümmung nach dem Signal ist die durch Schwerkraft hervorgerufene asymmetrische Verteilung des Auxins  \parencite[502-503]{Nultsch}.
