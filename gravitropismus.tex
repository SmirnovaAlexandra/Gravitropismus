...
Diese Fähigkeit der Pflanze, sich an der Schwerkraft zu orientieren, ermöglicht, dass sie um die begrenzten verfügbaren Ressourcen konkurrieren, aber auch sorgt diese Bewegungsorientierung dafür, dass die Pflanzensprossen nach einem Regen oder einer Windaktion jeglicher Art sich wieder aufrichten können. 
...
Gravitropismus umfasst mehrere Schritte, die spezifisch nach einem Schema ablaufen.
...
Dadurch kann die Organspitze die Wachstumsrichtung wieder aufnehmen.
...
Bei der gravitropischen Stimulation wird Auxin erzeugt und an die Reaktionsstelle weitergeleitet, wo es dann das differenzielle Wachstum fördert. (thaliana: A Model for the Study of Root and Shoot Gravitropism)
